...
| Текущий commit | `9535709bb` плюс незакоммиченный патч `marinara-world-maps-final-scene-location-v1.patch` |
...
- `patches/` — актуальные серверные патчи. Для World Maps подготовлены `marinara-world-maps-final-scene-location-v1.patch` и capability-архив `hierarchical-maps-1.4.3-alderwick.1.zip`; они рассчитаны на commit `9535709bb` и устанавливаются пользователем по безопасной процедуре из `PATCHES.md`.
