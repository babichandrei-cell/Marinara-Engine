...
Документ описывает состояние папки на 27 августа 2026 года. Он не заменяет документацию Marinara Engine, а служит навигацией по локальным материалам: кампании, настройкам и доработкам.
...
| `prompt-templates/` | Текстовые шаблоны инструкций для агентов-трекеров. |
...
Импортируемые архивы агентов. Каждый архив содержит манифест, настройки и основной prompt.
...
- `RP Core v0.6 Universal Dense.marinara.json` — экспорт пресета **RP Core v0.6 Universal Dense** для импорта в Marinara Engine.
...
- 53 исходных файла материалов проекта и девять Markdown-документов, не считая служебных `.DS_Store`.
