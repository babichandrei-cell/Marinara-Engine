...
- `Alderwick.marinara.json` — экспорт лорбука мира Alderwick от 29 августа 2026 года. Содержит 57 записей, включая реестр возможных повторяющихся NPC Альдервика.
...
- 36 файлов материалов проекта и девять Markdown-документов вне архивов патчей, не считая служебных `.DS_Store`.
